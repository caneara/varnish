    ...
    <div class="varnish-textbox varnish-font w-full">
        ...
        <div @mouseover="hover = true"
            ...
            <input :id="name"
                   ...
                   class="varnish-control varnish-input w-full bg-inherit font-[470] text-gray-900 dark:text-gray-400 text-ellipsis overflow-hidden rounded appearance-none pl-3 pt-[25px] pb-[7px]" />
            ...
            <textarea :id="name"
                      ...
                      :autocomplete="autocomplete"
                      @input="change($event.target.value)"
                      class="varnish-control varnish-textarea w-full bg-inherit font-470 text-gray-900 dark:text-gray-400 leading-snug rounded appearance-none resize-none pl-3 pr-11 pt-[25px]">
            </textarea>
