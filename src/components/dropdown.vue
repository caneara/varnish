	...
	<div class="varnish-dropdown varnish-font w-full">
        ...
        <div @mouseover="hover = true"
			...
			<select :id="name"
					...
					class="varnish-input w-full h-[51px] bg-inherit font-[470] text-gray-900 dark:text-gray-400 -tracking-[.2px] align-middle text-ellipsis overflow-hidden rounded appearance-none cursor-pointer pl-3">
