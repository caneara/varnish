<template>
    <div v-if="visible"
        ...
        <i :class="icon"
           v-if="! blank(icon)"
           class="varnish-icon text-[40px] text-sky-600/[.60] dark:text-sky-500/[.50] pt-1 mb-7">
        </i>
...
<script>
    ...
    export default
    {
		 ...
		 */
		props : {
            'actionCommand' : { type : Function, default : null },
            'actionLabel'   : { type : String,   default : '' },
			'icon'          : { type : String,   default : 'fas fa-cubes' },
